...
class Overlay(QWidget):
    def __init__(self):
        ...
        pin_icon = QIcon("Working UI/pin_icon.png")  # Replace with your actual icon path
        ...
        power_icon = QIcon("Working UI/power_icon.png")  # Replace with your actual icon path
        ...
        settings_icon = QIcon("Working UI/settings_icon.png")  # Replace with your actual icon path
        ...
        draw_icon = QIcon("Working UI/draw_icon.png")  # Replace with your actual icon path
        ...
        keyboard_icon = QIcon("Working UI/keyboard_icon.png")  # Replace with your actual icon path
