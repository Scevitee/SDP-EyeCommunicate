...
while True:
    ...
    for face in detector(gray, 0):
        ...
        (success, rotation_vector, translation_vector) = cv2.solvePnP(model_points, headpose_points, camera_matrix,
        ...
        cv2.putText(frame, f"Horizontal: {horiz_text}", (text_x_horiz, text_y_horiz), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 255, 0), 2)
        cv2.putText(frame, f"Vertical: {vert_text}", (test_x_vert, test_y_vert), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 255, 0), 2)
