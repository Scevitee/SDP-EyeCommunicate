...
class Overlay(QWidget):
    def __init__(self):
        ...
        pin_icon = QIcon("images/pin_icon.png")  # Replace with your actual icon path
        ...
        power_icon = QIcon("images/power_icon.png")  # Replace with your actual icon path
        ...
        settings_icon = QIcon("images/settings_icon.png")  # Replace with your actual icon path
        ...
        draw_icon = QIcon("images/draw_icon.png")  # Replace with your actual icon path
        ...
        keyboard_icon = QIcon("images/keyboard_icon.png")  # Replace with your actual icon path
